...
function figs_spectral_windows()
...
alpha=8; %specifies the cosine frequency
plot_fft_with_impulses(window_choice, alpha)
writeEPS('scalloping_rect_centered','font12Only')

window_choice = 3; %choose one among 3 possible windows
alpha=8; %specifies the cosine frequency
plot_fft_with_impulses(window_choice, alpha)
writeEPS('scalloping_flattop_centered','font12Only')

window_choice = 1; %choose one among 3 possible windows
alpha=8.5; %specifies the cosine frequency
plot_fft_with_impulses(window_choice, alpha)
writeEPS('scalloping_rect_noncentered','font12Only')

window_choice = 2; %choose one among 3 possible windows
alpha=8.5; %specifies the cosine frequency
plot_fft_with_impulses(window_choice, alpha)
writeEPS('scalloping_hann_noncentered','font12Only')

window_choice = 3; %choose one among 3 possible windows
alpha=8.5; %specifies the cosine frequency
plot_fft_with_impulses(window_choice, alpha)
writeEPS('scalloping_flattop_noncentered','font12Only')


%% Function to plot. Same as script snip_frequency_scalloping.m
function plot_fft_with_impulses(window_choice, alpha)
...
xlabel('Angular frequency \Omega (rad) normalized by \pi')
ylabel('Spectrum magnitude'), grid
legend('DTFT (impulse area divided by \pi)', 'FFT magnitude')
