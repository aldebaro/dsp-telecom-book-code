...
if 1 %if you have impulseResponses.wav available
    [h,Fs]=readwav('..\Applications\LoopbackMeasurements\impulseResponses.wav');
...
clf
%[x,Fs,b]=readwav('..\..\Applications\LoopbackMeasurements\filteredNoise.wav','native');
[x,Fs,b]=readwav('..\Applications\LoopbackMeasurements\filteredNoise.wav');
N=1024; %number of FFT points
