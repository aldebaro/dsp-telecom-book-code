...
h=[5.1; 0; 0; 0.5; 3; 0.2; -0.1]; %channel impulse response
...
for Delta=1:Nc %search for best delay Delta
    ...
    w=pinv(Hhat)*e; %find the equalizer
    %w2=inv(Hhat'*Hhat)*Hhat'*e; %use pseudoinverse property
...
stem(e), hold on, stem(conv(h,wbest),'r')