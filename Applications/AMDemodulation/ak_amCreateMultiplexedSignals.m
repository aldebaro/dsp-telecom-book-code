...
[x,Fs]=readwav(fileName); %Fs is the sampling frequency (Hz)
...
maxAbs=max(abs(y))+eps; %force to be within [-1,1[.
writewav(y/maxAbs,Fs_tx,'amMultiplexedSignals.wav','16r');
